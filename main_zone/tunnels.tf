# RETIRED 2026-09-05: argo tunnels / Zero Trust no longer in use (all 7 tunnels down/inactive; erfi.io is on Knot, Caddy issues LE via rfc2136). Resources are commented out - the next `tofu apply` DESTROYS everything below. The orphan k3s tunnel 88fdfdca-e2a1-485f-a7cb-d0d7d4eb4a0a is in no tf; remove it separately in the CF dashboard.
