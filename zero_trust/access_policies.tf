...
resource "cloudflare_access_policy" "prometheus_auth_token" {
  ...
  include {
    service_token = [cloudflare_access_service_token.prometheus_token.id]
  }
}
...
resource "cloudflare_access_policy" "tunnel_secret_worker" {
  ...
  include {
    service_token = [cloudflare_access_service_token.tunnel_secret_worker_token.id]
  }
}
...
resource "cloudflare_access_policy" "caddy_api_token" {
  ...
  include {
    service_token = [cloudflare_access_service_token.caddy_api_token.id]
  }
}
